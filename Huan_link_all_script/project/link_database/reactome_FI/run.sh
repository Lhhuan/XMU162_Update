...
perl 021_merge_ensg_position.pl #"/home/huanhuan/reference/grch38_ensg_pos_from_ensembl106.txt.gz"  注释 "./output/query_gene_ensembl.txt" 的位置，得"./output/021_query_gene_ensembl_pos.txt"
