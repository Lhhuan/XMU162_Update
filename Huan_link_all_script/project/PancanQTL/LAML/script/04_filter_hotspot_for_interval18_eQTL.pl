###"../output/NHP/NHPoisson_emplambda_interval_18_cutoff_7.30102999566398_LAML.txt.gz" 得hotspot(segment),"../output/04_LAML_cis_eQTL_hotspot.bed.gz"
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $f1 = "../output/NHP/NHPoisson_emplambda_interval_18_cutoff_7.30102999566398_LAML.txt.gz";
...
# }
my $fo3 = "../output/04_LAML_cis_eQTL_hotspot.bed.gz";
