bedtools getfasta -fi /share/Projects/huanhuan/ref_data/gencode/GRCh37.primary_assembly.genome.fa -bed  "/home/huanhuan/project/GTEx/output/Tissue_merge/hotspot_chr1_6/041_filter_length_6_1243_hotspot_chr1_6.bed" -fo "/share/data0/QTLbase/huan/GTEx/Tissue_merge/Cis_eQTL/hotspot/interval_18/chr1_6/kmer/6/Tissue_merge_segment_hotspot_cutoff_0.176.fa"
...
seekr_graph example_vs_self.csv 0.13 -g example_vs_self.gml -s 0 -c communities_s0.csv
seekr_graph example_vs_self.csv 0.13 -g example_vs_self.gml -n 5 -s 0 -c communities_5.csv
