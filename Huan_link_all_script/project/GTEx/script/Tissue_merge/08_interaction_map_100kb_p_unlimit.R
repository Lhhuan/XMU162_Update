...
TSS<-read.table("07_region_half_chr1_hotspot_eqtl_TSS_in_win100000_p_unlimit.bed.gz",header = F,sep = "\t") %>% as.data.frame()
eqtl<-read.table("07_region_half_chr1_hotspot_eqtl_in_win100000_p_unlimit.bed.gz",header = F,sep = "\t") %>% as.data.frame()
...
pheatmap(r3,cluster_rows = FALSE, cluster_cols = FALSE,color= color2,angle_col = 0,display_numbers = F,show_rownames = F,show_colnames = F,file="./figure/half_chr1_win_100kb_p_unlimit.png",dpi=300)

color2 = colorRampPalette(c('#c6dbef','#6baed6','#2171b5'))(50)
pheatmap(r3[1:500,1:500],cluster_rows = FALSE, cluster_cols = FALSE,color= color2,angle_col = 0,display_numbers = F,show_rownames = F,show_colnames = F,file="./figure/half_chr1_win_100kb_500_p_unlimit.png",dpi=300)
pheatmap(r3[1:300,1:300],cluster_rows = FALSE, cluster_cols = FALSE,color= color2,angle_col = 0,display_numbers = F,show_rownames = F,show_colnames = F,file="./figure/half_chr1_win_100kb_300_p_unlimit.png",dpi=300)
pheatmap(r3[200:500,200:500],cluster_rows = FALSE, cluster_cols = FALSE,color= color2,angle_col = 0,display_numbers = F,show_rownames = F,show_colnames = F,file="./figure/half_chr1_win_100kb_200_500_p_unlimit.png",dpi=300)
pheatmap(r3[300:600,300:600],cluster_rows = FALSE, cluster_cols = FALSE,color= color2,angle_col = 0,display_numbers = F,show_rownames = F,show_colnames = F,file="./figure/half_chr1_win_100kb_300_600_p_unlimit.png",dpi=300)

pheatmap(r3[480:520,480:520],cluster_rows = FALSE, cluster_cols = FALSE,color= color2,angle_col = 0,display_numbers = F,show_rownames = F,show_colnames = F,border=FALSE,file="./figure/half_chr1_win_100kb_480_520_p_unlimit.png",dpi=300)

pheatmap(r3[400:700,400:700],cluster_rows = FALSE, cluster_cols = FALSE,color= color2,angle_col = 0,display_numbers = F,show_rownames = F,show_colnames = F,border=FALSE,file="./figure/half_chr1_win_100kb_400_700_p_unlimit.png",dpi=300)
