...
my $fo1 = "../output/07_all_predict_need.bed.gz";
...
my $sort_f2 = "../output/07_all_predict_need_sorted.bed.gz";
my $leftoverlp = "../output/07_all_predict_need_left_overlap_hi_c.bed.gz";
