...
my $f1 = "../output/07_random_top0.1_need_left_overlap_hi_c.bed.gz";
open( my $I1 ,"gzip -dc $f1|") or die ("can not open input file '$f1' \n"); #读压缩文件
# open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n"; 
# my $f2 = "../output/05_random_top0.1.bed.gz";
# open( my $I2 ,"gzip -dc $f2|") or die ("can not open input file '$f2' \n"); #读压缩文件
my $fo1 = "../output/07_random_top0.1_gene_hotspot.bed.gz";
open my $O1, "| gzip >$fo1" or die $!;
my $fo2 = "../output/07_hic_overlap_top0.1_left_right_left.bed.gz";
...
my $sort_fo1 = "../output/07_random_top0.1_gene_hotspot_sorted.bed.gz";
my $sort_fo2 = "../output/07_hic_overlap_top0.1_left_right_left_sorted.bed.gz";
my $rightoverlp = "../output/07_random_top0.1_right_overlap_hi_c.bed.gz";
