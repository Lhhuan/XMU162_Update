...
my $hotspot_in_region = "../../output/Tissue_merge/Cis_eQTL/interaction_heatmap/07_region_${region}_hotspot_p_unlimit.bed";
my $eqtl_gene = "../../output/Tissue_merge/Cis_eQTL/06_sig_eQTL_gene_TSS_p_unlimit_sorted.bed.gz";
...
my $qtl_in_hotspot_region = "../../output/Tissue_merge/Cis_eQTL/interaction_heatmap/07_region_${region}_hotspot_eqtl_egene_p_unlimit.bed.gz";
my $qtl_in_r =  "../../output/Tissue_merge/Cis_eQTL/interaction_heatmap/07_in_region_${region}_eQTL_p_unlimit.bed.gz";
my $tss_in_r =  "../../output/Tissue_merge/Cis_eQTL/interaction_heatmap/07_in_region_${region}_eQTL_TSS_p_unlimit.bed.gz";
my $qtl_in_win = "../../output/Tissue_merge/Cis_eQTL/interaction_heatmap/07_region_${region}_hotspot_eqtl_in_win${win}_p_unlimit.bed.gz";
my $tss_in_win = "../../output/Tissue_merge/Cis_eQTL/interaction_heatmap/07_region_${region}_hotspot_eqtl_TSS_in_win${win}_p_unlimit.bed.gz";
