...
foreach my $i(@aa){
    ...
    my $fo1 = "/share/data0/QTLbase/huan/GTEx/Tissue_merge/Cis_eQTL/hotspot/interval_18/chr1_6/kmer/6/communities_${i}.bed.gz";
    ...
    foreach my $factor(@factors){
        ...
        my $command = "bedtools intersect -a $fo1  -b $factor_file -wa |sort -u |gzip >/share/data0/QTLbase/huan/GTEx/Tissue_merge/Cis_eQTL/hotspot/interval_18/chr1_6/kmer/6/factor_anno/${i}_community/${factor}.bed.gz" ;
        print "$factor_file\n";
        system $command;
    }
}