...
foreach my $j(@aa){
    ...
    my $output_dir = "/home/huanhuan/project/GTEx/script/Tissue_merge/chr1_6/6kmer/${j}_community/";
    if(-e $output_dir){
    ...
    for(my $i=1;$i<$j+1;$i++){
        # print "$i\n";
        my $f1 = "/share/data0/QTLbase/huan/GTEx/Tissue_merge/Cis_eQTL/hotspot/interval_18/chr1_6/kmer/6/${j}_community/homer/${i}/knownResults.txt";
