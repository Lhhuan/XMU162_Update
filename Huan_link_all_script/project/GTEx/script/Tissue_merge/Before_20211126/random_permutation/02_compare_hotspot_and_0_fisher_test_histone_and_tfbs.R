...
write.table(result,"./figure/0/compare_0_jaacard_index_fisher_test_histone_tfbs_two_side.txt",row.names = F, col.names = T,quote =F,sep="\t")
...
re_g <-lapply(marks,fisher_greater)
result_g <- do.call(rbind,re_g)

write.table(result_g,"./figure/0/compare_0_jaacard_index_fisher_test_histone_tfbs_greater.txt",row.names = F, col.names = T,quote =F,sep="\t")