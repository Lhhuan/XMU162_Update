###过滤出../../../../../output/Tissue_merge/Cis_eQTL/NHP/NHPoisson_emplambda_interval_${j}_cutoff_7.3_Tissue_merge.txt.gz 中emplambda$emplambda ==0，得 "../../../../../output/Tissue_merge/Cis_eQTL/hotspot_cis_eQTL/interval_18/sampling/Tissue_merge_segment_hotspot_cutoff_0.bed.gz"
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $f1 = "/share/Projects/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/${tissue}/Cis_eQTL/NHP/NHPoisson_emplambda_interval_${j}_cutoff_7.3_${tissue}.txt.gz";
...
print "cutoff\t$cutoff\n";
my $fo3 = "../../../../output/Tissue_merge/Cis_eQTL/hotspot_cis_eQTL/interval_18/sampling/Tissue_merge_segment_hotspot_cutoff_${cutoff}.bed.gz";
        ...
        if ($diff<0.00000000001){
            ...
            if ($content_count >0){
                ...
                if ($end_diff <2 ){ #距离hotspot 一行的位置
                    ...
                    my $bed_starts= $starts[0]+1-1; #转换科学计数法
