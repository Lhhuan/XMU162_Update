...
e <-setdiff(c(1:100000),unique(fa$eQTL_winnum))
S <-setdiff(c(1:100000),unique(fa$TSS_winnum))
ee <-data.frame(eQTL_winnum=setdiff(c(1:100000),unique(fa$eQTL_winnum)),TSS_winnum=1,count=0 )
ss <-data.frame(eQTL_winnum=1,TSS_winnum=setdiff(c(1:100000),unique(fa$TSS_winnum)),count=0 )
...
pheatmap(r3,cluster_rows = FALSE, cluster_cols = FALSE,color= color2,angle_col = 0,display_numbers = F,show_rownames = F,show_colnames = F,file="1MB_win_100.png",dpi=20)
