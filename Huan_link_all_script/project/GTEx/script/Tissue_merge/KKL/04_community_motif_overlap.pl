...
my $j= 6;
    ...
    my $output_dir = "/home/huanhuan/project/GTEx/script/Tissue_merge/KKL/homer/";
    if(-e $output_dir){
    ...
    for(my $i=1;$i<$j+1;$i++){
        # print "$i\n";
        my $f1 = "/home/huanhuan/project/GTEx/script/Tissue_merge/KKL/homer/${i}/knownResults.txt";
