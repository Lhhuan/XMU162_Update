...
dat$LDH_c[dat$LDH >245]=1 # dat$LDH_c[is.na(dat$LDH_c)]=dat$LDH0[is.na(dat$LDH_c)] dat$LDH0[is.na(dat$LDH_c)] is NA
...
pdf("./figure/10_3_pod24_pfs_cutoff1_adjust2.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
...
pdf("./figure/10_3_pod24_Os_cutoff1_adjust2.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
                palette=c("#21618C","#B71C1C"),
                legend.labs=c("Low","High"), #标签
                pval = TRUE,
