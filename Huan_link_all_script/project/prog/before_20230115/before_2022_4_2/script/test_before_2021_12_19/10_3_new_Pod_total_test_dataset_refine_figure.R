...
#-----------------------------------------------adjust1
test$SPD_c_f<- test$SPD_c *18.76
test$LDH_c_f <- test$LDH_c * 18.31
test$Lym_Mono_c_f <-test$Lym_Mono_c*17.16
test$B2mg_c_f <- test$B2mg_c*14.65
test$LN_num_c_f <-test$LN_num_c *8.24
test$Bsym_c_f <- test$Bsym_c*6.64
test$HGB_c_f<- test$HGB_c *4.35
test$Ki.67_c_f<- test$Ki.67_c *3.66
test$BM_c_f<-test$BM_c*3.43
test$age_raw_c_f <- test$age_raw_c*3.20
test$SUVmax_c_f<- test$SUVmax_c *1.60
...
# adjust1 <-test
#-----------------------------------------------adjust2
test$SPD_c_f<- test$SPD_c *16
test$LDH_c_f <- test$LDH_c * 16
test$Lym_Mono_c_f <-test$Lym_Mono_c*15
test$B2mg_c_f <- test$B2mg_c*13
test$LN_num_c_f <-test$LN_num_c *7
test$Bsym_c_f <- test$Bsym_c*6
test$HGB_c_f<- test$HGB_c *4
test$Ki.67_c_f<- test$Ki.67_c *3
test$BM_c_f<-test$BM_c*3
test$age_raw_c_f <- test$age_raw_c*3
...
#--------------------------------------------------------------------------8
library(plotROC)
longtest <-melt_roc(test,"new_pod_total",c("FLIPI1_count","FLIPI2_count","primapi_re_n","X150b2mg_ldh","adjust1","adjust2","adjust3"))
