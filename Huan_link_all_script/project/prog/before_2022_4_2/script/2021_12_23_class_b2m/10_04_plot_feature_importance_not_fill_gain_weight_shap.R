...
library(ggpubr)
library(Hmisc)
dat <- read.csv("/home/huanhuan/project/prog/output/10_03_not_fill_feature_importance_weight.txt",na.strings = "",sep="\t")
...
dat$Feature <-gsub("B2MG_re0_train","β2-MG >UNL",dat$Feature)
dat$Feature <-gsub("LDH_re0_train","LDH >UNL",dat$Feature)
...
#
#--------------------gain
dat <- read.csv("/home/huanhuan/project/prog/output/10_03_not_fill_feature_importance_gain.txt",na.strings = "",sep="\t")
dat$Feature <-as.factor(dat$Feature)
dat$Feature <-gsub("LN_num","Lymph nodes",dat$Feature)
dat$Feature <-gsub("extend_num","Extra sites",dat$Feature)
dat$Feature <-gsub("BM_extend","Extra BM",dat$Feature)
...
#---------------------shap
dat <- read.csv("/home/huanhuan/project/prog/output/10_03_not_fill_feature_importance_shap_class.txt",na.strings = "",sep="\t")
dat <-abs(dat)
...
data1$Feature <-gsub("B2MG_re0_train","β2-MG >UNL",data1$Feature)
data1$Feature <-gsub("LDH_re0_train","LDH >UNL",data1$Feature)
