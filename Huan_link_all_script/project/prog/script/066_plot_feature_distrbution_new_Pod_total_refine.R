...
p1 <-ggplot(data =pod_total3 , mapping = aes(x=Var1,y=Freq)) + geom_bar(stat = 'identity', fill = "#5eaaa8", width=0.5)+
...
dat$SPD_c <-dat$SPD
dat$SPD_c[dat$SPD_c <=21.44]=0
dat$SPD_c[dat$SPD_c >21.44]=1
...
dat$HGB_c <-dat$HGB
dat$HGB_c[dat$HGB_c <=118]=1
dat$HGB_c[dat$HGB_c >118.00 ]=0
...
fit <- survfit(Surv(pfs_month_new, pro_status) ~ Predict_Pod_total_f, data=dat1)
pdf("./figure/066_pre_survival_3a_pod_total_new_sum_pfs_new_cutoff.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total new",
                 title="3a: Pfs",
...
#------------------------------
fit <- survfit(Surv(os_month_new, dead) ~ Predict_Pod_total_f, data=dat1)
pdf("./figure/066_pre_survival_3a_pod_total_new_sum_Os_new_cutoff.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total new",
                 title="3a: Os",
...
fit <- survfit(Surv(pfs_month_new, pro_status) ~ Predict_Pod_total_f, data=dat1)
pdf("./figure/066_pre_survival_3a_pod_total_new_sum_pfs_adjust1_new_cutoff.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total new",
                 title="3a: Pfs",
...
#------------------------------
fit <- survfit(Surv(os_month_new, dead) ~ Predict_Pod_total_f, data=dat1)
pdf("./figure/066_pre_survival_3a_pod_total_new_sum_Os_adjust1_new_cutoff.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total new",
                 title="3a: Os",
...
fit <- survfit(Surv(pfs_month_new, pro_status) ~ Predict_Pod_total_f, data=dat1)
pdf("./figure/066_pre_survival_3a_pod_total_new_sum_pfs_adjust2_new_cutoff.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total new",
                 title="3a: Pfs",
...
#------------------------------
fit <- survfit(Surv(os_month_new, dead) ~ Predict_Pod_total_f, data=dat1)
pdf("./figure/066_pre_survival_3a_pod_total_new_sum_Os_adjust2_new_cutoff.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total new",
                 title="3a: Os",
...
dat$Predict_Pod_total_f <-dat$predict_Podtotal_new
dat1 <-dat[order(dat$Predict_Pod_total_f),]
dat1$Predict_Pod_total_f[dat1$Predict_Pod_total_f<17 ]=0
dat1$Predict_Pod_total_f[dat1$Predict_Pod_total_f>=17 ]=1

fit <- survfit(Surv(pfs_month_new, pro_status) ~ Predict_Pod_total_f, data=dat1)
pdf("./figure/066_pre_survival_3a_pod_total_new_sum_pfs_adjust2_new_cutoff_ycutoff_17.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total new",
                 title="3a: Pfs",
...
#------------------------------
fit <- survfit(Surv(os_month_new, dead) ~ Predict_Pod_total_f, data=dat1)
pdf("./figure/066_pre_survival_3a_pod_total_new_sum_Os_adjust2_new_cutoff_ycutoff_17.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total new",
                 title="3a: Os",
...
dat1[a:nrow(dat),"Predict_Pod_total_f"]=1 
fit <- survfit(Surv(pfs_month_new, pro_status) ~ Predict_Pod_total_f, data=dat1)
pdf("./figure/066_pre_survival_3a_pod_total_new_sum_pfs_adjust3_new_cutoff.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total new",
                 title="3a: Pfs",
...
#------------------------------
fit <- survfit(Surv(os_month_new, dead) ~ Predict_Pod_total_f, data=dat1)
pdf("./figure/066_pre_survival_3a_pod_total_new_sum_Os_adjust3_new_cutoff.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total new",
                 title="3a: Os",
