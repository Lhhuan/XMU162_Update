...
#------------------------------------------------------------------new_cutoff
dat$Lym_Mono_c <-NA
dat$Lym_Mono_c[dat$Lym_Mono <=5]=0
dat$Lym_Mono_c[dat$Lym_Mono >5 ]=1
...
dat$Ki.67_c <-NA 
dat$Ki.67_c[dat$Ki.67 <=70.00]=0
dat$Ki.67_c[dat$Ki.67 >70.00 ]=1
...
pdf("./figure/094_cutoff2_roc8.pdf",width=7,height=6)
p <-ggplot(longtest,aes(d=D,m=M,color=name))+geom_roc() + scale_fill_manual(values=mycolor)+#,color=name aes(color=mycolor)
...
longtest$name <- capitalize(longtest$name)
# setwd("/share/Projects/huanhuan/project/prog/")
pdf("./figure/094_cutoff2_roc_adjust4.pdf",width=7,height=6)
p <-ggplot(longtest,aes(d=D,m=M,color=name))+geom_roc() + scale_fill_manual(values=mycolor)+#,color=name aes(color=mycolor)
  p_theme+xlab("FPR")+ylab("TPR") #+scale_x_continuous(expand=c(0,0)) + scale_y_continuous(expand=c(0,0))
auc  <- calc_auc(p)$AUC
names(auc) <-levels(factor(longtest[,"name"]))
...
longtest$name <- capitalize(longtest$name)
# setwd("/share/Projects/huanhuan/project/prog/")
pdf("./figure/094_cutoff2_roc_adjust2.pdf",width=7,height=6)
p <-ggplot(longtest,aes(d=D,m=M,color=name))+geom_roc() + scale_fill_manual(values=mycolor)+#,color=name aes(color=mycolor)
  p_theme+xlab("FPR")+ylab("TPR") #+scale_x_continuous(expand=c(0,0)) + scale_y_continuous(expand=c(0,0))
auc  <- calc_auc(p)$AUC
names(auc) <-levels(factor(longtest[,"name"]))
...
pdf("./figure/094_cutoff2_roc_adjust3.pdf",width=7,height=6)
p <-ggplot(longtest,aes(d=D,m=M,color=name))+geom_roc() + scale_fill_manual(values=mycolor)+#,color=name aes(color=mycolor)
  p_theme+xlab("FPR")+ylab("TPR") #+scale_x_continuous(expand=c(0,0)) + scale_y_continuous(expand=c(0,0))
auc  <- calc_auc(p)$AUC
names(auc) <-levels(factor(longtest[,"name"]))
...
pdf("./figure/test/094_pod24_pfs_cutoff2_adjust2.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
...
pdf("./figure/test/094_pod24_Os_cutoff2_adjust2.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
                palette=c("#21618C","#B71C1C"),
                legend.labs=c("Low","High"), #标签
                pval = TRUE,
...
pdf("./figure/test/094_pod24_pfs_cutoff2_adjust3.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
                palette=c("#21618C","#B71C1C"),
                legend.labs=c("Low","High"), #标签
                pval = TRUE,
...
pdf("./figure/test/094_pod24_Os_cutoff2_adjust3.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
                palette=c("#21618C","#B71C1C"),
                legend.labs=c("Low","High"), #标签
                pval = TRUE,
...
pdf("./figure/test/094_pod24_pfs_cutoff2_adjust4.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
                palette=c("#21618C","#B71C1C"),
                legend.labs=c("Low","High"), #标签
                pval = TRUE,
...
pdf("./figure/test/094_pod24_Os_cutoff2_adjust4.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
                palette=c("#21618C","#B71C1C"),
                legend.labs=c("Low","High"), #标签
                pval = TRUE,
