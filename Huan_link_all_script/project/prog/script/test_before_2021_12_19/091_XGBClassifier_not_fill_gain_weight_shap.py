...
im_gain_df.to_csv("../output/091_not_fill_feature_importance_gain.txt",sep="\t",index=None)
#--------------------------------------
...
im_weight_df.to_csv("../output/091_not_fill_feature_importance_weight.txt",sep="\t",index=None)
...
feature_shap.to_csv("../output/091_feature_importance_shap_class.txt",sep="\t",index=None)