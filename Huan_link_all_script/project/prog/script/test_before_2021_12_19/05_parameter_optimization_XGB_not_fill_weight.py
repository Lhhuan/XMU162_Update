...
gsearch1 = GridSearchCV(estimator = XGBClassifier(objective = "multi:softprob",eval_metric= "mlogloss",use_label_encoder=False,learning_rate = 0.1,n_estimators=50, seed=1024,importance_type='weight'), 
                       param_grid = param_test1, scoring='accuracy',cv=5)
gsearch1.fit(train_X,train_Y)
gsearch1.best_params_, gsearch1.best_score_
#{'max_depth': 3, 'min_child_weight': 5}
param_test3 = {'gamma':[i/10.0 for i in range(0,30)]}
gsearch3 = GridSearchCV( estimator =XGBClassifier(min_child_weight =5,max_depth= 3, objective = "multi:softprob",eval_metric= "mlogloss",use_label_encoder=False,learning_rate = 0.1,n_estimators=50, seed=1024,importance_type='weight'), 
...
gsearch4 = GridSearchCV( estimator =XGBClassifier(gamma= 2.4, min_child_weight =5,max_depth= 3, objective = "multi:softprob",eval_metric= "mlogloss",use_label_encoder=False,learning_rate = 0.1,n_estimators=50, seed=1024,importance_type='weight'), 
...
gsearch5 = GridSearchCV( estimator =XGBClassifier(gamma= 2.4, min_child_weight =5,max_depth= 3, objective = "multi:softprob",eval_metric= "mlogloss",use_label_encoder=False,learning_rate = 0.1,n_estimators=50, seed=1024,importance_type='weight'), 
                       param_grid = param_test5, scoring='accuracy',n_jobs=4, cv=5)
gsearch5.fit(train_X,train_Y)
gsearch5.best_params_, gsearch5.best_score_
#{'colsample_bytree': 0.5, 'subsample': 0.65}
#------------
param_test6 = {
    'reg_alpha':[1e-5, 1e-2, 0.1, 1, 100]
}
gsearch6 = GridSearchCV( estimator =XGBClassifier(colsample_bytree = 0.5, subsample= 0.65,gamma= 2.4, min_child_weight =5,max_depth= 3, objective = "multi:softprob",eval_metric= "mlogloss",use_label_encoder=False,learning_rate = 0.1,n_estimators=50, seed=1024,importance_type='weight'), 
...
gsearch7 = GridSearchCV( estimator =XGBClassifier(reg_alpha= 1e-5,colsample_bytree = 0.5, subsample= 0.65,gamma= 2.4, min_child_weight =5,max_depth= 3, objective = "multi:softprob",eval_metric= "mlogloss",use_label_encoder=False,learning_rate = 0.1,n_estimators=50, seed=1024,importance_type='weight'), 
