...
y = dataset.loc[:, 'pfs_month'].values
...
#{'objective': 'reg:squarederror'} is the default
...
#{'colsample_bytree': 0.2, 'gamma': 0.4, 'max_depth': 9, 'min_child_weight': 1, 'subsample': 0.9}
...
gsearch5 = GridSearchCV(estimator = XGBRegressor(booster='gbtree',
                    ...
                    nthread=10,
                    seed=27),
                       param_grid = param_test5, scoring='neg_mean_squared_error',n_jobs=10, cv=10)
gsearch5.fit(train_X,train_Y)
gsearch5.best_params_, gsearch5.best_score_
#{'reg_alpha': 1e-06},
param_test6 = {
    'reg_alpha':[9e-7,1e-6,2e-6] #----------修改
}
