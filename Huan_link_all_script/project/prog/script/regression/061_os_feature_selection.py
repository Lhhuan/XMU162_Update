...
plt.savefig('output/figure/06_feature_importance_3a_not_fill_os.pdf')
...
f_sel_step1= f_sel
f_weight_step1.to_csv("output/06_step1_feature_importance_3a_not_fill_os.txt",sep="\t",index=None)
f_sel_step1.to_csv("output/06_step1_feature_selection_3a_not_fill_os.txt",sep="\t",index=None)
#------------------------------------------------------------------------------------------------step2
X = dataset.loc[:, ['gender','Ki.67','stage','Bsym','LN_num','site0','extend','BM','spleen','extend_num','BM_extend','LN6','SUVmax','SPD','X150b2mg_ldh','b2mg_LDH','ECOG','B2mg','LDH','LDH0','WBC','HGB','HGB0','PLT','Mono','Lym','age_raw','age_raw_60','ki67_20','LN_num_6','extend_num_0','SUVmax_2','LDH_300','B2mg_3.4','SPD_0']]
y = dataset.loc[:, 'OS_month']
X_COL = X.columns
# X= dataset.iloc[:,1:540]
# y = dataset.loc[:, 'AUC'].values
...
#--------------------------
f_weight_step2.to_csv("output/06_step3_feature_importance_3a_not_fill_os.txt",sep="\t",index=None)
f_sel_step2.to_csv("output/06_step3_feature_selection_3a_not_fill_os.txt",sep="\t",index=None)
