...
dat <- read.csv("08_XGBClassifier_predict_3a_fill_CV_step3_f_s.txt",na.strings = "",sep="\t")
...
pdf("./figure/09_pred_new_pod_total_3a_pfs_CV_fill_step3_f_s.pdf")
p1 <- ggsurvplot(fit,
                pval = TRUE,
...
pdf("./figure/09_pred_new_pod_total_3a_Os_CV_fill_step3_f_s.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
...
pdf("./figure/09_pred_pod_total_3a_pfs_CV_fill_step3_f_s.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod_total",
                 title="Pfs",
...
pdf("./figure/09_pred_pod_total_3a_Os_CV_fill_step3_f_s.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total",
                 title="Os",
...
# pdf("./figure/06_FLIPI1_3a_pfs_CV.pdf")
# p1 <- ggsurvplot(fit,
#                   pval = TRUE,
#                  legend.title="Pod_total",
#                  title="Pfs",
...
# pdf("./figure/06_FLIPI1_3a_Os_CV.pdf")
# p1 <- ggsurvplot(fit,
#                   pval = TRUE,
#                  legend.title="Pod total",
#                  title="Os",
