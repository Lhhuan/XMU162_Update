...
dat <- read.csv("06_XGBRegressor_predict_3a_not_fill.txt",na.strings = "",sep="\t")
...
pdf("./figure/06_pred_new_pod_total_3a_pfs.pdf")
p1 <- ggsurvplot(fit,
                pval = TRUE,
...
pdf("./figure/06_pred_new_pod_total_3a_Os.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
...
pdf("./figure/06_pred_pod_total_3a_pfs.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod_total",
                 title="Pfs",
...
pdf("./figure/06_pred_pod_total_3a_Os.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total",
                 title="Os",
...
pdf("./figure/06_FLIPI1_3a_pfs.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod_total",
                 title="Pfs",
...
pdf("./figure/06_FLIPI1_3a_Os.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total",
                 title="Os",
