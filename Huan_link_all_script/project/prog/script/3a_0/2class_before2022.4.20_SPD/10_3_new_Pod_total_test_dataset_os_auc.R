...
dat$SPD_c_f<- dat$SPD_c *1

dat$sum_score<-base::rowSums(dat[,c("LDH_c_f","LN_num_c_f","HGB_c_f","ECOG_c_f","B2M_c_f","Lym_Mono_c_f","BM_c_f","SPD_c_f")])
# dat[is.na($sum_score),]
dat$adjust5 <- dat$sum_score
...
ggsave("./figure/10_3_roc_adjust5_ALL_dead.png",p2,dpi=300,width=7,height=5.8)
pdf("ALL_os.pdf")
print(p2)
dev.off()
#-----------
