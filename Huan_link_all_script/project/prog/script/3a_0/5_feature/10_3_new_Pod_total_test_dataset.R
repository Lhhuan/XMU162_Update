...
test$sum_score<-base::rowSums(test[,c("B2M_c_f","HGB_c_f","LDH_c_f","Lym_Mono_c_f","LN_num_c_f")])
...
#--------------------------------------------------------------------------8
library(plotROC)
longtest <-melt_roc(test,"new_pod_total",c("FLIPI1_count","FLIPI2_count","primapi_re_n","b2mg_ldh1.5s","adjust3","adjust4","adjust5"))
