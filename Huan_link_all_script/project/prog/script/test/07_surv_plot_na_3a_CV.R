...
dat <- read.csv("06_XGBClassifier_predict_3a_not_fill_CV.txt",na.strings = "",sep="\t")
...
pdf("./figure/07_pred_new_pod_total_3a_pfs_CV.pdf")
p1 <- ggsurvplot(fit,
                pval = TRUE,
...
pdf("./figure/07_pred_new_pod_total_3a_Os_CV.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
...
pdf("./figure/07_pred_pod_total_3a_pfs_CV.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod_total",
                 title="Pfs",
...
pdf("./figure/07_pred_pod_total_3a_Os_CV.pdf")
p1 <- ggsurvplot(fit,
                  pval = TRUE,
                 legend.title="Pod total",
                 title="Os",
