...
X = dataset.loc[:, ['Ki.67','stage','Bsym','LN_num','BM','extend_num','BM_extend','LN6','SUVmax','SPD','b2mg_LDH','ECOG','B2mg','LDH','LDH0','WBC','HGB','PLT','Mono','Lym','interm_res','end_res','CR','Rmaintain','age_raw','LN_num_6']].values
...
dataset.to_csv("../output/08_XGBClassifier_predict_3a_not_fill_CV_step6_f_s.txt",sep="\t",index=None)
