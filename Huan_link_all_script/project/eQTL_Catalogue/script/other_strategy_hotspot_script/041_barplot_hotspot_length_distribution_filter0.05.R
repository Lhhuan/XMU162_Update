...
org$class<-factor(org$class,levels=c("1","2-10","11-100","101-500","501-1,000","1,001-1,500","1,501-2,000","2,001-5,000","5,001-10,000",">10,000"))
l_c <- table(org$class)%>%data.frame()
colnames(l_c) <-c("Length","Frequency")

write.table(l_c,"041_egene0.05_hotspot_distribution_bar.txt",row.names=F,quote=F,sep="\t")

pdf("./041_egene0.05_barplot_hotspot_distribution.pdf",width = 4,height = 4)
