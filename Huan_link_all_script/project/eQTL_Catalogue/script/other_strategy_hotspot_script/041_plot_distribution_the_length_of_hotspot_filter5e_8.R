...
org<-read.table("/home/huanhuan/project/eQTL_Catalogue/output/all_tissue_status/hotspot/Tissue_merge_segment_hotspot_cutoff_0.176_egene_5e_8.bed.gz",header = F,sep = "\t") %>% as.data.frame()
colnames(org)[1] <-"CHR"
colnames(org)[2] <-"start"
colnames(org)[3] <-"end"
org$hotspot_length <-org$end - org$start
setwd("/home/huanhuan/project/eQTL_Catalogue/script/figure/")
pdf("041_egene_5e_8_boxplot_distribution_extend_hotspot_length_log10.pdf",width=3.5, height=3.5)
...
pdf("041_egene_5e_8_boxplot_distribution_extend_hotspot_length_log10_no_ylim.pdf",width=3.5, height=3.5)
...
write.table(stat,"041_egene_5e_8_distribution_of_extend_hotspot_length.txt",row.names = F, col.names = T,quote =F,sep="\t")
...
pdf("041_egene_5e_8_log10_length_distribution_chr.pdf",width=10.3, height=8)
