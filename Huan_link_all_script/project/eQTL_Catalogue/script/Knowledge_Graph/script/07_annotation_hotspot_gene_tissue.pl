...
my $f1= "../output/edges_annotation/hotspot_gene_chr_split/02_merge_all_tissue_cis_eQTL_eur_egene_sig_5e_8_sorted.bed.gz";
system "bedtools intersect -a $sorted_input_file -b /home/huanhuan/project/eQTL_Catalogue/output/02_merge_all_tissue_cis_eQTL_eur_egene_sig_5e_8_sorted.bed.gz -wa -wb |cut -f1-3,7-9|gzip > ${f1}" ;
...
# for (my $i=1;$i<23;$i++){
#     print "$i\tstart\n";
#     my $f1= "../output/edges_annotation/hotspot_gene_chr_split/02_merge_all_tissue_cis_eQTL_eur_egene_sig_5e_8_sorted_chr${i}.bed.gz";
#     system "bedtools intersect -a $sorted_input_file -b /home/huanhuan/project/eQTL_Catalogue/output/02_gene_chr_split/02_merge_all_tissue_cis_eQTL_eur_egene_sig_5e_8_sorted_chr${i}.bed.gz -wa -wb |cut -f1-3,7-9|gzip > ${f1}" ;
