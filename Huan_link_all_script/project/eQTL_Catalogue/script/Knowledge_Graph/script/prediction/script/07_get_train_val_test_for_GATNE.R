...
setwd("/home/huanhuan/project/eQTL_Catalogue/script/Knowledge_Graph/script/prediction/output/")
...
write.table(test,"./huan_GATNE_all/test.txt",row.names = F, col.names = F,quote =F,sep=" ")
write.table(val,"./huan_GATNE_all/valid.txt",row.names = F, col.names = F,quote =F,sep=" ")
#---------
...
train <-train[,c(3,1,2)]
write.table(train,"./huan_GATNE_all/train.txt",row.names = F, col.names = F,quote =F,sep=" ")

train_hf <-train_h[,c(3,1,2)]
write.table(train_hf,"./huan_GATNE_all/train.txt",row.names = F, col.names = F,quote =F,sep=" ")
