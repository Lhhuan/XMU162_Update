...
setwd("/home/huanhuan/project/eQTL_Catalogue/script/Knowledge_Graph/script/prediction/script/chr1_2/output/")
...
write.table(test,"./huan_GATNE_chr1_2/test.txt",row.names = F, col.names = F,quote =F,sep=" ")
write.table(val,"./huan_GATNE_chr1_2/valid.txt",row.names = F, col.names = F,quote =F,sep=" ")
#---------
...
train <-train[,c(3,1,2)]
write.table(train,"./huan_GATNE_chr1_2/train.txt",row.names = F, col.names = F,quote =F,sep=" ")

train_hf <-train_h[,c(3,1,2)]
write.table(train_hf,"./huan_GATNE_chr1_2/train.txt",row.names = F, col.names = F,quote =F,sep=" ")
