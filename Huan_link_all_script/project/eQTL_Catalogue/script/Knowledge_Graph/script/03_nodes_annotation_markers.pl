#用带有样本信息的10种marker及enhancer 对"/home/huanhuan/project/eQTL_Catalogue/output/all_tissue_status/hotspot/Tissue_merge_segment_hotspot_cutoff_0.176_extend_18_snp_sorted_merge.bed.gz" 进行注释得../output/nodes_annotation/${markers}_Tissue_merge_segment_hotspot_cutoff_0.176_extend_18_snp_sorted_merge.bed.gz
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $out_dir = "/home/huanhuan/project/eQTL_Catalogue/script/Knowledge_Graph/output/nodes_annotation/";
