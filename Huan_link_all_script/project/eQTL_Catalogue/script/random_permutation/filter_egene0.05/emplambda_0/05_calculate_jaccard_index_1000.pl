...
for (my $i=1;$i<1001;$i++){
    foreach my $mark (@markers){
        my %hash1;
        my $input_file_base_name = "${mark}_${i}_resemble_Tissue_merge_segment_hotspot_cutoff_0.176_egene_0.05.bed.gz";
        ...
        my $f3 = "${resemble_dir}/${i}_resemble_Tissue_merge_segment_hotspot_cutoff_0.176_egene_0.05.bed.gz";
