...
my $cutoff2 = "0";
my $output_dir=  "/share/data0/QTLbase/huan/eQTL_Catalogue/original_random/extend/emp${cutoff}/${cutoff2}";
...
my $command12 = "zless  /home/huanhuan/project/eQTL_Catalogue/output/all_tissue_status/hotspot/Tissue_merge_segment_hotspot_cutoff_0.176_extend_sorted_merge.bed.gz >> $anno_dir/complement_final_${cutoff2}.bed"; #Hotspot 进行了extend，所以exclude不仅仅是emp 0 的互补，还有extend的部分 既最终用不在hotspot中的emp0为背景
