...
my $input_file = "/home/huanhuan/project/eQTL_Catalogue/output/all_tissue_status/hotspot/Tissue_merge_segment_hotspot_cutoff_0.176_egene_0.05.bed.gz"; #hotspot 
my $input_file_base_name = basename($input_file);
# $input_file_base_name =~ s/Tissue_merge/Tissue_merge/g;
my $cutoff2 = "0";
my $output_dir=  "/share/data0/QTLbase/huan/eQTL_Catalogue/original_random/filter0.05/emp${cutoff}/${cutoff2}";
...
my $basic_simulate = "Tissue_merge_segment_hotspot_cutoff_${cutoff2}_sorted.bed.gz";
...
my $command12 = "zless  /home/huanhuan/project/eQTL_Catalogue/output/all_tissue_status/hotspot/Tissue_merge_segment_hotspot_cutoff_0.176_egene_0.05.bed.gz >> $anno_dir/complement_final_${cutoff2}.bed"; #Hotspot 进行了extend，所以exclude不仅仅是emp 0 的互补，还有extend的部分 既最终用不在hotspot中的emp0为背景
