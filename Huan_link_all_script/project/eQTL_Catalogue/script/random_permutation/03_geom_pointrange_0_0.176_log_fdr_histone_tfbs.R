...
setwd("/home/huanhuan/project/eQTL_Catalogue/output/enrichment/figure/0_0.176/")
...
pdf("fisher_test_0_0.176_jaacard_index_forest_plot_log_histone_tfbs.pdf",height = 3.5,width = 3.8) #
...
ggsave("fisher_test_0_0.176_jaacard_index_forest_plot_log_histone_tfbs_forest.png",p3,dpi=300,width=6.5,height=5)
