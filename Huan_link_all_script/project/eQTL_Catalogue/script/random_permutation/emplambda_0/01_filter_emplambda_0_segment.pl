...
print "cutoff\t$cutoff\n";
my $fo3 = "/home/huanhuan/project/eQTL_Catalogue/output/sampling/Tissue_merge_segment_hotspot_cutoff_${cutoff}.bed.gz";
...
system "zless $fo3 |sort -k1,1 -k2,2n |gzip > /home/huanhuan/project/eQTL_Catalogue/output/sampling/Tissue_merge_segment_hotspot_cutoff_${cutoff}_sorted.bed.gz"