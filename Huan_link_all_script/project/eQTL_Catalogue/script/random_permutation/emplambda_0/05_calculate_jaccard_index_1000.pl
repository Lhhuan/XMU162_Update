...
my $cutoff = 0.176;
my $group = "hotspot";
my $type = "random_extend_18snp";
my $cutoff2 = "0";



# my $input_dir = "/share/data0/QTLbase/huan/eQTL_Catalogue/original_random/filter0.05/emp${cutoff}/${cutoff2}";
my $input_dir=  "/share/data0/QTLbase/huan/eQTL_Catalogue/original_random/extend_18snp/emp${cutoff}/${cutoff2}";
...
my $out_dir=  "/home/huanhuan/project/eQTL_Catalogue/output/enrichment";

my $fo1 = "$out_dir/${type}_${cutoff2}_jaccard_index_marker_1000.txt.gz";
...
for (my $i=1;$i<1001;$i++){
    foreach my $mark (@markers){
        my %hash1;
        my $input_file_base_name = "${mark}_${i}_resemble_Tissue_merge_segment_hotspot_cutoff_0.176_extend_18_snp_sorted_merge.bed.gz";
        ...
        my $f3 = "${resemble_dir}/${i}_resemble_Tissue_merge_segment_hotspot_cutoff_0.176_extend_18_snp_sorted_merge.bed.gz";
