...
pdf("041_ori_boxplot_distribution_extend_hotspot_length_log10.pdf",width=3.5, height=3.5)
...
pdf("041_ori_boxplot_distribution_extend_hotspot_length_log10_no_ylim.pdf",width=3.5, height=3.5)
...
write.table(stat,"041_ori_distribution_of_extend_hotspot_length.txt",row.names = F, col.names = T,quote =F,sep="\t")
...
# pdf("041_ori_log10_length_distribution_chr.pdf",width=10.3, height=8)
