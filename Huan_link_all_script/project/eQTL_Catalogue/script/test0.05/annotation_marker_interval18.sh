...
#hg38
bedtools intersect -a $sorted_input_file -b "/share/Projects/huanhuan/project/RNA/eQTL_associated_interaction/annotation/annotation_data/CTCF/normal_cell_line/hg38/05_normal_cell_line_ctcf_sort_union_merge.bed.gz" -wo | gzip > $output_dir/CTCF_$input_file_base_name
