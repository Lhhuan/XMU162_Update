...
setwd("/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/using_umap_clustering/re_3e_5/gene/")
...
Cluster <-read.table("../../../11_whole_genome_umap_leiden_pca5_k50_resolution3e-05.txt",header = T,sep = "\t") %>% as.data.frame()
