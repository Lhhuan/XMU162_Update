...
setwd("/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/3pca_2cluster/ChromHMM/")
enrichment <-read.table("merge_15_state_enrichment.txt.gz",header = T,sep = "\t") %>% as.data.frame()
