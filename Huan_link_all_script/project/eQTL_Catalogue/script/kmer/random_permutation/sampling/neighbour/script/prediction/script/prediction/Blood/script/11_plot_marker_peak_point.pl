...
my $dir="/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/script/prediction/script/prediction/Blood/output/";
my @levels=("mean","max");
...
foreach my $level(@levels){
    ...
    foreach my $marker(@markers){
        my $marker_bw = "/share/data0/GTEx/annotation/ROADMAP/sample/tissue_specific/${tissue}/hg38/${marker}_merge_${level}_signalvalue.bw";
...
foreach my $level(@levels){
    ...
    foreach my $marker1(@cistromes){
        my $marker_bw ="/share/Projects/huanhuan/project/RNA/eQTL_associated_interaction/annotation/annotation_data/cistromeDB/tissue_specific_normal_line/${marker1}/${tissue}/merge_${level}_signalvalue.bw";
        my $marker= $marker1;
