...
my $dir="/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/script/prediction/script/marker_landscape/output/";
# system "cp $dir/homer_200/*.bed $dir/markers/";
# # my @levels=("max","mean","median");
my @levels=("mean","max");
my $cluster_inputdir = "$dir/markers_na0/";
...
foreach my $level(@levels){
     my $output_dir ="$dir/markers_na0/${level}";
...
#     $ENV{'marker_bw'} = $marker_bw ;
#     $ENV{'output_dir'} = $output_dir ;
#     system "bash computeMatrix_sample.sh";
#     print "$marker\t$level\n";
# }