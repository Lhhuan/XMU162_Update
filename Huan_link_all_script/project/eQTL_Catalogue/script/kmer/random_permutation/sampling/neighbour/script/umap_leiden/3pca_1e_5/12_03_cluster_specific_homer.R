...
setwd("/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/using_umap_clustering/3pca_1e_5/homer_200/")
...
p1 <-ggplot(data = cluster_n, mapping = aes(x =Cluster, y = Number_of_motif,fill=Cluster)) +
     ...
     scale_fill_manual(values=c("#1E77B4","#FF7F0E","#2CA02C","#C22324","#9567BD","#8C554B","#E277C1","#7F7F7F","#15BECE"))+
...
tmp2 <-lapply(1:10,cluster_specific)
...
p1 <-ggplot(data = cluster_specifc_n, mapping = aes(x =Cluster, y = Number_of_motif,fill=Cluster)) +
     geom_bar(stat = 'identity', width=0.8)+
     scale_fill_manual(values=c("#1E77B4","#2CA02C","#C22324","#9567BD","#8C554B","#E277C1","#7F7F7F","#15BECE"))+
