...
setwd("/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/CPG_island/")
org <- read.table("../17_whole_genome_leiden_pca5_k30_resolution1e-04_sorted.bed.gz",header = F,sep = "\t") %>% as.data.frame()
