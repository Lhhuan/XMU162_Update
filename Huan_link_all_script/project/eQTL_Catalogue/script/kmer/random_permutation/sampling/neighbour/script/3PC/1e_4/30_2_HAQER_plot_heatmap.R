...
setwd("/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/3pca_1e_4/HAQER/")
...
rownames(M_enrichment_C1) <-paste0("C",1:6)

p1 <- Heatmap(M_enrichment_C1, name = "Overlap enrichment", row_names_side = "left", column_names_side = "top",
