...
setwd("/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/using_umap_clustering/3pca_5e_6/GC_content/")
org <-read.table("gc_content.bed.gz",header = T,sep = "\t") %>% as.data.frame()

org <-filter(org,cluster %in%c(1:7))
