...
my @levels=("max");
my $cluster_inputdir = "/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/homer_200";
...
foreach my $level(@levels){
     my $output_dir ="/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/markers/point/${level}";
    foreach my $marker(@markers){
        ...
        system "bash plot_chip_seq_point.sh";
        print "$marker\t$level\n";
    }
}
