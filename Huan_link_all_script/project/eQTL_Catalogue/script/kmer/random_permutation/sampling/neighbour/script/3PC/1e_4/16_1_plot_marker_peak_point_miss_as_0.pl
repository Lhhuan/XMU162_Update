...
my $dir="/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/3pca_1e_4";
...
foreach my $level(@levels){
     my $output_dir ="$dir/markers/miss_as_0/${level}";
