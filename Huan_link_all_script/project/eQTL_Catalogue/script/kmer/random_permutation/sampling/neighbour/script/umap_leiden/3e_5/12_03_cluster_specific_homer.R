...
setwd("/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/using_umap_clustering/re_3e_5/homer_200/")

org <-read.table("../../../11_whole_genome_umap_leiden_pca5_k50_resolution3e-05.txt",header = T,sep = "\t") %>% as.data.frame()
...
p1 <-ggplot(data = cluster_n, mapping = aes(x =Cluster, y = Number_of_motif,fill=Cluster)) +
     ...
     scale_fill_manual(values=c("#1E77B4","#FF7F0E","#2CA02C","#C22324","#9567BD","#E277C1","#7F7F7F","#BCBC22","#15BECE"))+
