...
my $dir="/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/using_umap_clustering/3pca_5e_6";
...
foreach my $level(@levels){
     my $output_dir ="$dir/markers/${level}";
