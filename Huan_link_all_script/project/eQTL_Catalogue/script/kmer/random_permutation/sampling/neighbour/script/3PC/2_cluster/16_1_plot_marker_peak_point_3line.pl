...
my $dir="/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/3pca_2cluster";
# system "cp $dir/homer_200/*.bed $dir/markers/";
# my @levels=("max","mean","median");
my @levels=("mean","max");
my $cluster_inputdir = "$dir/markers/";
...
foreach my $level(@levels){
     my $output_dir ="$dir/markers/point_3line/${level}";
    foreach my $marker(@markers){
        ...
        system "bash plot_chip_seq_point_umap_3line.sh";
        print "$marker\t$level\n";
    }
}
...
#=============pol2
# foreach my $level(@levels){
#     my $output_dir ="$dir/markers/point_2line/${level}";
...
#     $ENV{'marker_bw'} = $marker_bw ;
#     $ENV{'output_dir'} = $output_dir ;
#     system "bash plot_chip_seq_point_umap_2line.sh";
#     print "$marker\t$level\n";
# }
