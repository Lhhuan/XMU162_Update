computeMatrix reference-point \
            ...
            -R ${cluster_inputdir}/cluster_1.bed \
                ...
                ${cluster_inputdir}/cluster_11.bed \
            --samplesLabel ${marker}\
...
plotProfile -m ${output_dir}/${marker}_${level}.gz \
              ...
              --colors "#1E77B4" "#FF7F0E" "#2CA02C" "#C22324" "#9567BD" "#8C554B" "#E277C1" "#7F7F7F" "#BCBC22" "#15BECE" "#A6BDDD"\
              --plotHeight 10.5 \
              --plotWidth 10 \
              --refPointLabel 'center'  --regionsLabel "C1" "C2" "C3" "C4" "C5" "C6" "C7" "C8" "C9" "C10" "C11"\
              --yAxisLabel "" 
