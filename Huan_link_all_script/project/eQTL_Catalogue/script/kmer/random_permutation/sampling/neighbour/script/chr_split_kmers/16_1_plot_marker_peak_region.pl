...
my $cluster_inputdir = "/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/09_chr/chr1/homer_200";
# my @levels=("mean");
# my @markers=("H3K4me1");
my @levels=("mean","median","max");
# my @levels=("median","max");
my @markers=("H3K27ac","H3K4me1","H3K4me3","H3K9ac","H3K36me3","H3K27me3","H3K9me3");
foreach my $level(@levels){
     my $output_dir ="/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/09_chr/chr1/markers/region/${level}";
    foreach my $marker(@markers){
        ...
        system "bash plot_chip_seq_region.sh";
        print "$marker\t$level\n";
    }
}
...
# # my $ctcf ="/share/Projects/huanhuan/project/RNA/eQTL_associated_interaction/annotation/annotation_data/CTCF/normal_cell_line/hg38/normal_cell_line_ctcf_merge_${level}_signalvalue.bw";