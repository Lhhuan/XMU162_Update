...
for(my $i=1;$i<11;$i++){
    ...
    my $out_dir1 = "/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/using_umap_clustering/3pca_1e_5/homer_200";
    if(-e $out_dir1){
