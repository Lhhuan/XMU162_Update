...
setwd("/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/homer_200/")

org <-read.table("../11_whole_genome_leiden_pca5_k30_resolution1e-04.txt",header = T,sep = "\t") %>% as.data.frame()
