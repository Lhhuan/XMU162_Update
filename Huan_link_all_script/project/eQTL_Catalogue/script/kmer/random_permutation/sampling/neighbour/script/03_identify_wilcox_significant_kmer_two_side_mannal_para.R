...
re1_200 <- lapply(1:200,kmer_test)
re201_400 <- lapply(201:400,kmer_test)
re401_600 <- lapply(401:600,kmer_test)
re601_800 <- lapply(601:800,kmer_test)
re801_1000 <- lapply(801:1000,kmer_test)
