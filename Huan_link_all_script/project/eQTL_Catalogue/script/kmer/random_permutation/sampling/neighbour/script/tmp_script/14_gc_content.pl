...
my $fo2 = "/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/GC_content/gc_content.bed.gz";
...
for(my $i=1;$i<8;$i++){
    ...
    my $out_dir1 = "/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/GC_content";
    if(-e $out_dir1){
