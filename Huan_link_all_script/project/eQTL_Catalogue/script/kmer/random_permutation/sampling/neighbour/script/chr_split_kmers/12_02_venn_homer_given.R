...
library(ggpval)
library(VennDiagram)
setwd("/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/09_chr/chr1/homer")
rm(list=ls())
q<-0.05

tf <-read.table(paste0("homer_result_qvalue",q,".txt"),header = T,sep = "\t") %>% as.data.frame()
...
AAA <- list(C3=ff(3),C6=ff(6),C7=ff(7))
...
my_c2 =c( "darkorange1", "seagreen3", "orchid3")
