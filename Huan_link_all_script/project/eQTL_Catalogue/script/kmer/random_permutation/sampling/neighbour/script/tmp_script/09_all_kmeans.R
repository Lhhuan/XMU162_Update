...
write.table(Sorg,"08_hotspot_permutation_wilocx_overlap_sig_kmer_0_1000.txt",row.names = F, col.names = T,quote =F,sep="\t")
# Sorg_all <-Sorg
...
save(pca,file="08_all_PCA_rbfdot.Rdata")
library(factoextra)
p1 <-fviz_screeplot(pca,ncp=30,addlabels = TRUE,font.x=c(5),font.y=c(16),font.main=c(5))
ggsave("08_all_PCA_rbfdot_screeplot.pdf",p1,dpi=300,width=10,height=5)
...
ggsave("08_all_PCA_rbfdot_cluster_new.png",p,dpi=150,width=5,height=5)
...
ggsave("08_all_PCA_rbfdot_tsn_cluster_new.png",p,dpi=150,width=5,height=5)
#---------------
...
ggsave("08_all_PCA_rbfdot_Umap_cluster_new.png",p,dpi=150,width=5,height=5)
dat <-Sorg
