...
setwd("/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/using_umap_clustering/3pca_1e_5/gene/")
...
Cluster <-read.table("../../../11_whole_genome_umap_leiden_pca3_k30_resolution1e-05.txt",header = T,sep = "\t") %>% as.data.frame()
...
all_gene_count1 <-filter(all_gene_count,cluster %in%c(1:10))
