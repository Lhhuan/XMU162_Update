...
setwd("/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/3pca_2e_4/CPG_island/")
org <- read.table("../../11_whole_genome_leiden_pca3_k50_resolution2e-04.txt",header = T,sep = "\t") %>% as.data.frame()
...
dat1 <- filter(dat,cluster %in%c(1:11))
