...
foreach my $level(@levels){
     my $output_dir ="$dir/markers/miss_as_zero_3line/${level}";
    foreach my $marker(@markers){
        ...
        system "bash plot_chip_seq_point_umap_miss_as_zero_3line.sh";
        print "$marker\t$level\n";
    }
}
...
# foreach my $level(@levels){
#     my $output_dir ="$dir/markers/miss_as_zero/${level}";
