...
org_out <- unique(org[,c(1,2,4,5)])
write.table(org_out,"../output/02_cancer_cellLine_marker.txt",row.names = F, col.names = T,quote =F,sep="\t")
...
for (i in 1:length(unique(org$tmp_tissue))){
