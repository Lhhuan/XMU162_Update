...
my $out_dir1 = "/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/3pca_2e_4/GC_content/";
if(-e $out_dir1){
...
for(my $i=1;$i<12;$i++){
    my $f1 = "../../../output/figure/whole_genome/11_whole_genome_leiden_pca3_k50_resolution2e-04.txt";
