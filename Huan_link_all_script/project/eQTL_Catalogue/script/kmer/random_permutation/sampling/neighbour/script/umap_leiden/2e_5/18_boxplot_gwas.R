...
setwd("/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/neighbour/output/figure/whole_genome/using_umap_clustering/re_2e_5/GWAS/")
org <-read.table("17_whole_genome_umap_leiden_pca5_k50_resolution2e-05_gwas_metaid.bed.gz",header = T,sep = "\t") %>% as.data.frame()
