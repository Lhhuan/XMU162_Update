...
my $fo1 = "/share/data0/QTLbase/huan/eQTL_Catalogue/ChromHMM/output/merge_15_state_enrichment.txt.gz";
...
foreach my $state(@states){
    # print "$state\n";
    my $dir = "/share/data0/QTLbase/huan/eQTL_Catalogue/ChromHMM/output/${state}";
