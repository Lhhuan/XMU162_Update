...
load("/home/huanhuan/project/eQTL_Catalogue/script/kmer/figure/hotspot_kmer_need_test_value.Rdata")
...
all_random_kmer_need_test_value <-do.call(rbind,a)
# setwd("/home/huanhuan/project/eQTL_Catalogue/script/kmer/random_permutation/sampling/emplambda_0/figure/")
setwd("/share/data0/QTLbase/huan/eQTL_Catalogue/kmer/random/emp0/figure/")
...
write.table(rs,"./figure/hotspot_emplambda_0_random_kmer_wilcox.txt",row.names = F, col.names = T,quote =F,sep="\t")
