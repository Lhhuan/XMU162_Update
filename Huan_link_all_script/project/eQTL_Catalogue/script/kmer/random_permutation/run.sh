...
# perl 02_get_kmer_count.pl 
Rscript 03_count_kmer_count.R

Rscript 04_identify_wilcox_significant_kmer.R
...
seekr_kmer_counts sorted_${i}_resemble_${tissue}_segment_${group}_cutoff_${cutoff}.fa -o ${i}_6mers_uc_us_no_log.csv --log2 none -uc -us
done
