...
pdf("./figure/094_pod24_pfs_cutoff2_adjust2.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
...
pdf("./figure/094_pod24_Os_cutoff2_adjust2.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
                palette=c("#21618C","#B71C1C"),
                legend.labs=c("Low","High"), #标签
                pval = TRUE,
...
pdf("./figure/094_pod24_pfs_cutoff2_adjust3.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
                palette=c("#21618C","#B71C1C"),
                legend.labs=c("Low","High"), #标签
                pval = TRUE,
...
pdf("./figure/094_pod24_Os_cutoff2_adjust3.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
                palette=c("#21618C","#B71C1C"),
                legend.labs=c("Low","High"), #标签
                pval = TRUE,
...
pdf("./figure/094_pod24_pfs_cutoff2_adjust4.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
                palette=c("#21618C","#B71C1C"),
                legend.labs=c("Low","High"), #标签
                pval = TRUE,
...
pdf("./figure/094_pod24_Os_cutoff2_adjust4.pdf",height=5.2,width=5)
p1 <- ggsurvplot(fit,
                palette=c("#21618C","#B71C1C"),
                legend.labs=c("Low","High"), #标签
                pval = TRUE,
