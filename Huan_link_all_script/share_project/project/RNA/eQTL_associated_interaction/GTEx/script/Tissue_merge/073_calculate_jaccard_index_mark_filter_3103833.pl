...
my $fo1 = "$out_dir/${group}_cutoff_${cutoff}_marker_jaccard_index_filter_3103833.txt.gz";
...
foreach my $mark (@markers){
    my %hash1;
    my $input_file_base_name = "${mark}_Tissue_merge_segment_hotspot_cutoff_0.176_extend_sorted_merge_filter_3103833.bed.gz";
    ...
    my $f3 = "/share/Projects/huanhuan/project/RNA/eQTL_associated_interaction/GTEx/output/Tissue_merge/Cis_eQTL/hotspot_cis_eQTL/interval_18/Tissue_merge_segment_hotspot_cutoff_0.176_extend_sorted_merge_filter_3103833.bed.gz";
