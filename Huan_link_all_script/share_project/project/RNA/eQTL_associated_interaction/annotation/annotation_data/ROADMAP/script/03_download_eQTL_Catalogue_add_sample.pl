...
my $f1 = "new_add_roadmap.txt";
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n"; 
# open( my $I1 ,"gzip -dc $f1|") or die ("can not open input file '$f1' \n"); #读压缩文件

my $fo1 = "eQTL_Catalogue_add_sample_id.txt";
...
while(<$I1>)
{
    ...
    unless(/^EID/){
        ...
        foreach my $marker(@markers){
            ...
            $ENV{'marker'} = $marker ;
            system "bash /share/Projects/huanhuan/project/RNA/eQTL_associated_interaction/annotation/annotation_data/ROADMAP/script/download_markers.sh";
            print "$marker\n";
            $pm->finish;  #多线程结束
        }
    }
