...
perl 04_merge_eQTL_Catalogue_marker.pl #利用all_eQTL_Catalogue_sample_id_unique.txt将不同sample的相同mark进行合并，得 "/share/data0/GTEx/annotation/ROADMAP/sample/merge/${marker}_sorted_merge.bed.gz"
...
perl 04_merge_eQTL_Catalogue_marker_sample.pl #在04_merge_eQTL_Catalogue_marker.pl 的基础上加上sample信息，排序得"/share/data0/GTEx/annotation/ROADMAP/sample/merge/${marker}_sorted_sample.bed.gz"
perl 05_tranform_hg19_to_hg38_sample.pl #将"/share/data0/GTEx/annotation/ROADMAP/sample/merge/${marker}_sorted_sample.bed.gz" 从 hg19转换到hg38,得"/share/data0/GTEx/annotation/ROADMAP/sample/merge/hg38/${marker}_sorted_sample.bed.gz"