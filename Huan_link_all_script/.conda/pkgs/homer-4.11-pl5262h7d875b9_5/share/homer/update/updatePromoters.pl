...
foreach(@sets) {
	...
	print STDERR "\tloadPromoters.pl -name $org -org $org -id $idtype -force -version $version -genome $genome -tss ../data/genomes/$genome/$genome.tss -size $size -dist $redunDist\n";
